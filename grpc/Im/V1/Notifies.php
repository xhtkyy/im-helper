...
/**
 * Generated from protobuf message <code>im.v1.Notifies</code>
 */
class Notifies extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Im\V1\Notify::class);
        $this->arr = $arr;
